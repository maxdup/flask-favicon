...
def test_init():
    ...
    assert group.filenameSchema == 'apple-touch-icon-{}x{}.png'
...
def test_generate_images(mock_gen_image):
    ...
    expected_calls = [
        mock.call(FAVICON, size=(180, 180), use_background=True,
                  filename='apple-touch-icon.png'),
        mock.call(FAVICON, size=(180, 180), use_background=True,
                  filename='apple-touch-icon-precomposed.png')
    ]
    expected_calls.extend([mock.call(FAVICON, size=size, use_background=True)
